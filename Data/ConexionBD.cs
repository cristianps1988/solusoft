...
namespace Solusoft.Data
{
    public class ConexionBD
    {
        ...
        private bool AbrirConexion()
        {
            try
            {
                  strCadenaCnx = "Data Source=MAXDELL233;Initial Catalog = SoluSoftDB; Integrated Security = True";
               // strCadenaCnx = "workstation id=DB_API_EJEMPLO_2024.mssql.somee.com;packet size=4096;user id=carcamolm_SQLLogin_1;pwd=hjkwmlous5;data source=DB_API_EJEMPLO_2024.mssql.somee.com;persist security info=False;initial catalog=DB_API_EJEMPLO_2024;TrustServerCertificate=True";
